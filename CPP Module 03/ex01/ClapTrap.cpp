...
ClapTrap::~ClapTrap() {
	std::cout << "Destructor for ClapTrap: " << this->_name << "👏 is called" << std::endl;
}
...
void	ClapTrap::takeDamage(unsigned int amount) {
  ...
  std::cout << "ClapTrap: " << this->_name << "👏 has taken " << amount
            ...
            << " hit points(health) left!(" << this->_energyPoints << " energy points)" << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount){
	...
	std::cout << "ClapTrap: " << this->_name << "👏 has restored " << amount
			  << " of energy and now has " << this->_hitPoints << " hit points(health) left!(" << this->_energyPoints << " energy points)" << std::endl;
}
